                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :items="3" :nav="false" :dots="false" :loop="true">
                                    <div class="pt" @click="gantiGambar(thumbs[0])" :class="thumbs[0] == gambarDefault ? 'active' :''">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="gantiGambar(thumbs[1])" :class="thumbs[1] == gambarDefault ? 'active' :''">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="gantiGambar(thumbs[2])" :class="thumbs[2] == gambarDefault ? 'active' :''">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="gantiGambar(thumbs[3])" :class="thumbs[3] == gambarDefault ? 'active' :''">
